...
def calculate_axis_angles(prev_axes, curr_axes):
    """
    Calculates the angle between each principal axis
    (in degrees) for approximate rotation analysis.
    """
    angles = []
    for i in range(3):
        u = prev_axes[i]
        ...
        angles.append(angle)
    return angles  # [ΔAxis1, ΔAxis2, ΔAxis3]
